...
SRC_URI = "git://git@github.com/cu-ecen-aeld/assignments-3-and-later-Shifting5164;protocol=ssh;branch=master"

PV = "1.0+git${SRCPV}"
# DONE: set to reference a specific commit hash in your assignment repo
SRCREV = "8886af940787a45219a2a27f8bdad536a802af08"
...
# https://docs.yoctoproject.org/ref-manual/classes.html#ref-classes-update-rc-d
inherit update-rc.d
